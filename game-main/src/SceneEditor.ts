...
export class SceneEditor {
	private readonly _gameObjects: [Rectangle, typeof Wall | typeof Platform][];
				...
				case "ArrowUp":
					if (this._selectedRectangle !== null) {
						if (this._shiftPressed)
							this._gameObjects[this._selectedRectangle][0] = new Rectangle(
								this._gameObjects[this._selectedRectangle][0].X,
								this._gameObjects[this._selectedRectangle][0].Y,
								this._gameObjects[this._selectedRectangle][0].Width,
								this._gameObjects[this._selectedRectangle][0].Height + 1
							);
						else
							this._gameObjects[this._selectedRectangle][0] = new Rectangle(
								this._gameObjects[this._selectedRectangle][0].X,
								this._gameObjects[this._selectedRectangle][0].Y + 1,
								this._gameObjects[this._selectedRectangle][0].Width,
								this._gameObjects[this._selectedRectangle][0].Height
							);
					}
					break;
				case "ArrowDown":
					...
					if (this._selectedRectangle !== null) {
						if (this._shiftPressed)
							this._gameObjects[this._selectedRectangle][0] = new Rectangle(
								this._gameObjects[this._selectedRectangle][0].X,
								this._gameObjects[this._selectedRectangle][0].Y,
								this._gameObjects[this._selectedRectangle][0].Width + 1,
								this._gameObjects[this._selectedRectangle][0].Height
							);
						else
							this._gameObjects[this._selectedRectangle][0] = new Rectangle(
								this._gameObjects[this._selectedRectangle][0].X + 1,
								this._gameObjects[this._selectedRectangle][0].Y,
								this._gameObjects[this._selectedRectangle][0].Width,
								this._gameObjects[this._selectedRectangle][0].Height
							);
	...
	public Instantiate(object: Platform | Wall) {
